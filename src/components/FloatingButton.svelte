<script>
    ...
    onMount(() => floatingBtn = document.getElementById("floating-btn"))
...
<a id="floating-btn" class="rounded-full bg-sky-500 p-4 fixed right-0 bottom-0 m-10" onclick={() => window.scrollTo({ top: 0 })} href="/#" aria-label="Scroll to top">
